...
import io.github.lijinhong11.mdatabase.enums.JoinType;
import io.github.lijinhong11.mdatabase.enums.OrderType;
...
public class SelectSQL extends SQL {
    ...
    public SelectSQL join(String table, String onClause) {
        return join(table, onClause, JoinType.INNER);
    }
    ...
    public SelectSQL leftJoin(String table, String onClause) {
        return join(table, onClause, JoinType.LEFT);
    }

    public SelectSQL rightJoin(String table, String onClause) {
        return join(table, onClause, JoinType.RIGHT);
    }

    public SelectSQL fullJoin(String table, String onClause) {
        return join(table, onClause, JoinType.FULL);
    }
